...
const { crearEmailNodemailer } = require('../../src/emailSender/model/emailModel')
const assert = require('assert')
const { crearEmailSenderNodemailer } = require('../../src/emailSender/nodemailer')
...
describe('CON MODELOS DE EMAILS INVÁLIDOS Y CAMPOS FALTANTES', () => {
    ...
    describe('envío nodemailer de email con campos mínimos y archivo adjunto', () => {

...
function crearclienteREST(port) {
    return {
        ...
        getAllCharacters: async (bearerJwtToken) => {
            ...
            /// VALID TO USE ON FUTURE VERSIONS: api/characters?name=equal&name=abel&age=between&age=30&age=50
        ...
        addMovieToCharacterWithIds: async (bearerJwtToken, characterId, movieId) => {
            return await sendRequest({ url: crearURLBaseWithoutAPI(port) + `/api/characters/${characterId}/movies`, method: 'post', data: { movieId }, headers: { Authorization: bearerJwtToken }, withCredentials: true, })
        },
        ///////////////////////////////////////////////////////
        addCharacterToMovieWithIds: async (bearerJwtToken, movieId, characterId) => {
            return await sendRequest({ url: crearURLBaseWithoutAPI(port) + `/api/movies/${movieId}/characters`, method: 'post', data: { characterId }, headers: { Authorization: bearerJwtToken }, withCredentials: true, })
        },
        /////////////////////////////////////////////////////
        addMovieToMovieGenreWithIds: async (bearerJwtToken, movieGenreId, movieId) => {
            return await sendRequest({ url: crearURLBaseWithoutAPI(port) + `/api/movieGenres/${movieGenreId}/movies`, method: 'post', data: { movieId }, headers: { Authorization: bearerJwtToken }, withCredentials: true, })
        },
        /////////////////////////////////////////////////////
